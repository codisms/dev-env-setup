...
`curl -sSL https://bitbucket.org/codisms/dev-setup/raw/centos7/setup.sh | bash -s <host_name>`

To install without changing host name:

`curl -sSL https://bitbucket.org/codisms/dev-setup/raw/centos7/setup.sh | bash -s`
